...
public class HotelEntity {
	...
	public HotelEntity(String hotelName, int hotelNo, String source, String destination, Date checkInDate,
	...
	public String toString() {
		return "HotelEntity [hotelName=" + hotelName + ", hotelNo=" + hotelNo + ", source=" + source + ", destination="
				+ destination + ", checkInDate=" + checkInDate + ", checkOutDate=" + checkOutDate + ", departureTime="
